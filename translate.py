...
def translate(schema, word) :
	...
	print('word : %s' % word.encode('utf-8', errors='ignore').decode('utf-8', errors='ignore'))
	...
	print('result : %s' % ",".join(result).encode('utf-8', errors='ignore').decode('utf-8', errors='ignore'))
	return result
