...
for size in [100, 200, 300, 400] :
	for window in [3, 5, 7, 9] :
		...
		result_title = open('result/' + prefix + str(size) + "_" + str(window) + "_title" + ".txt", 'w')
		result_desc = open('result/' + prefix + str(size) + "_" + str(window) + "_desc" + ".txt", 'w')
		result_narr = open('result/' + prefix + str(size) + "_" + str(window) + "_narr" + ".txt", 'w')
